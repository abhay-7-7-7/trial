...
/* 🔹 NEW: Main search bar like ChatGPT */
function enterMainSearchMode() {
  searchMode = true;
  const searchContainer = document.getElementById('search-container');
  const cardsContainer = document.getElementById('cards-container');

  searchContainer.classList.add('chatgpt-mode');
  cardsContainer.classList.add('stack-left');
}
...
function resetSearchMode() {
  ...
  cardsContainer.classList.remove('stack-left');
...
function handleSearch() {
  ...
  if (query) {
    ...
    resultDiv.textContent = `🤖 Thinking about "${query}" ...`;
